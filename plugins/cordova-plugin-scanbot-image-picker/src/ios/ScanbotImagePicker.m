...
#import "ScanbotImagePickerMapper.h"
#import "ScanbotImagePickerConfiguration.h"
#import "ScanbotImagePickerUI.h"

@interface ScanbotImagePicker : CDVPlugin //<GMImagePickerControllerDelegate>
...
@implementation ScanbotImagePicker

- (void)pickImage:(CDVInvokedUrlCommand*)command {
    
    // Creates Single Image Picker Configuration
    NSDictionary* configuration = [self getConfigDictionary:command];
    ScanbotImagePickerSingleConfiguration* imagePickerConfiguration = [[ScanbotImagePickerSingleConfiguration alloc] init];
    
    @try {
        [ScanbotImagePickerMapper populateInstance:imagePickerConfiguration fromDictionary:configuration];
    }
    ...
    __weak ScanbotImagePicker* _self = self;
    [[ScanbotImagePickerUI shared] startSingleImagePicker:imagePickerConfiguration
...
- (void)pickImages:(CDVInvokedUrlCommand*)command {
    ...
    NSDictionary* configuration = [self getConfigDictionary:command];
    ScanbotImagePickerMultipleConfiguration* imagePickerConfiguration = [[ScanbotImagePickerMultipleConfiguration alloc] init];
    ...
    __weak ScanbotImagePicker* _self = self;
    [[ScanbotImagePickerUI shared] startMultipleImagePicker:imagePickerConfiguration
